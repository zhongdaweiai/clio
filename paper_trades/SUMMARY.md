...
- **3203** signals issued so far across **129** daily scans
- **700** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-05** (1 day from now)
...
- [`2026-09-04.json`](2026-09-04.json) — today's raw output (if today's scan ran)
