...
- **1363** signals issued so far across **67** daily scans
- **291** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-04** (1 day from now)
...
- [`2026-07-03.json`](2026-07-03.json) — today's raw output (if today's scan ran)
