...
- **2575** signals issued so far across **106** daily scans
- **412** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-13** (1 day from now)
...
- [`2026-08-12.json`](2026-08-12.json) — today's raw output (if today's scan ran)
