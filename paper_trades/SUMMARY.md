...
- **2877** signals issued so far across **118** daily scans
- **634** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-25** (1 day from now)
...
- [`2026-08-24.json`](2026-08-24.json) — today's raw output (if today's scan ran)
