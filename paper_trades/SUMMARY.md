...
- **200** signals issued so far across **9** daily scans
- **196** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-15** (9 days from now)
...
- [`2026-05-06.json`](2026-05-06.json) — today's raw output (if today's scan ran)
