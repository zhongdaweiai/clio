...
- **2913** signals issued so far across **119** daily scans
- **668** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-27** (2 days from now)
...
- [`2026-08-25.json`](2026-08-25.json) — today's raw output (if today's scan ran)
