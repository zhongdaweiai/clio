...
- **2149** signals issued so far across **89** daily scans
- **731** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-26** (1 day from now)
...
- [`2026-07-25.json`](2026-07-25.json) — today's raw output (if today's scan ran)
