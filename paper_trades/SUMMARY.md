...
- **2461** signals issued so far across **101** daily scans
- **312** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-09** (2 days from now)
...
- [`2026-08-07.json`](2026-08-07.json) — today's raw output (if today's scan ran)
