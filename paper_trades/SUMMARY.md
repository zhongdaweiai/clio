...
- **224** signals issued so far across **10** daily scans
- **220** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-15** (8 days from now)
...
- [`2026-05-07.json`](2026-05-07.json) — today's raw output (if today's scan ran)
