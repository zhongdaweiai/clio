...
- **831** signals issued so far across **38** daily scans
- **447** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-07** (3 days from now)
...
- [`2026-06-04.json`](2026-06-04.json) — today's raw output (if today's scan ran)
