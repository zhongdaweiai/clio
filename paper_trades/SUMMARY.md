...
- **311** signals issued so far across **14** daily scans
- **307** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-15** (4 days from now)
...
- [`2026-05-11.json`](2026-05-11.json) — today's raw output (if today's scan ran)
