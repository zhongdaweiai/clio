...
- **2595** signals issued so far across **107** daily scans
- **419** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-14** (1 day from now)
...
- [`2026-08-13.json`](2026-08-13.json) — today's raw output (if today's scan ran)
