...
- **2705** signals issued so far across **113** daily scans
- **500** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-20** (1 day from now)
...
- [`2026-08-19.json`](2026-08-19.json) — today's raw output (if today's scan ran)
