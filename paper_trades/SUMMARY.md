...
- **3759** signals issued so far across **146** daily scans
- **1035** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-22** (1 day from now)
...
- [`2026-09-21.json`](2026-09-21.json) — today's raw output (if today's scan ran)
