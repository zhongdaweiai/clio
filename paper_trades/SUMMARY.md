...
- **396** signals issued so far across **18** daily scans
- **371** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-16** (1 day from now)
...
- [`2026-05-15.json`](2026-05-15.json) — today's raw output (if today's scan ran)
