...
- **2759** signals issued so far across **115** daily scans
- **521** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-24** (3 days from now)
...
- [`2026-08-21.json`](2026-08-21.json) — today's raw output (if today's scan ran)
