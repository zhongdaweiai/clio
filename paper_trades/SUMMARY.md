...
- **1169** signals issued so far across **56** daily scans
- **596** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-23** (1 day from now)
...
- [`2026-06-22.json`](2026-06-22.json) — today's raw output (if today's scan ran)
