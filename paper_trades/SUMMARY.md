...
- **1682** signals issued so far across **75** daily scans
- **552** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-12** (1 day from now)
...
- [`2026-07-11.json`](2026-07-11.json) — today's raw output (if today's scan ran)
