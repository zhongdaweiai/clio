...
- **2319** signals issued so far across **96** daily scans
- **192** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-04** (3 days from now)
...
- [`2026-08-01.json`](2026-08-01.json) — today's raw output (if today's scan ran)
