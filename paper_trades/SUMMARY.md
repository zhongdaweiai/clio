...
- **2839** signals issued so far across **117** daily scans
- **601** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-24** (1 day from now)
...
- [`2026-08-23.json`](2026-08-23.json) — today's raw output (if today's scan ran)
