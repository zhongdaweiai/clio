...
- **551** signals issued so far across **23** daily scans
- **495** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-21** (1 day from now)
...
- [`2026-05-20.json`](2026-05-20.json) — today's raw output (if today's scan ran)
