...
- **1546** signals issued so far across **72** daily scans
- **448** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-09** (1 day from now)
...
- [`2026-07-08.json`](2026-07-08.json) — today's raw output (if today's scan ran)
