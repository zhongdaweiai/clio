...
- **1800** signals issued so far across **78** daily scans
- **610** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-15** (1 day from now)
...
- [`2026-07-14.json`](2026-07-14.json) — today's raw output (if today's scan ran)
