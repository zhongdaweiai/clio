...
- **3602** signals issued so far across **141** daily scans
- **912** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-20** (4 days from now)
...
- [`2026-09-16.json`](2026-09-16.json) — today's raw output (if today's scan ran)
