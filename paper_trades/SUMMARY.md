...
- **2230** signals issued so far across **92** daily scans
- **807** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-29** (1 day from now)
...
- [`2026-07-28.json`](2026-07-28.json) — today's raw output (if today's scan ran)
