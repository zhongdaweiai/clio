...
- **1303** signals issued so far across **65** daily scans
- **243** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-02** (1 day from now)
...
- [`2026-07-01.json`](2026-07-01.json) — today's raw output (if today's scan ran)
