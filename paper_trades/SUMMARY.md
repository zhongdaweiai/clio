...
- **146** signals issued so far across **7** daily scans
- **142** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-15** (11 days from now)
...
- [`2026-05-04.json`](2026-05-04.json) — today's raw output (if today's scan ran)
