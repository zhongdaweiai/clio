...
- **3299** signals issued so far across **132** daily scans
- **768** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-08** (1 day from now)
...
- [`2026-09-07.json`](2026-09-07.json) — today's raw output (if today's scan ran)
