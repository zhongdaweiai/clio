...
- **618** signals issued so far across **26** daily scans
- **560** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-24** (1 day from now)
...
- [`2026-05-23.json`](2026-05-23.json) — today's raw output (if today's scan ran)
