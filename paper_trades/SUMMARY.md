...
- **2252** signals issued so far across **93** daily scans
- **754** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-30** (1 day from now)
...
- [`2026-07-29.json`](2026-07-29.json) — today's raw output (if today's scan ran)
