...
- **3825** signals issued so far across **148** daily scans
- **1100** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-28** (5 days from now)
...
- [`2026-09-23.json`](2026-09-23.json) — today's raw output (if today's scan ran)
