...
- **3891** signals issued so far across **150** daily scans
- **1166** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-28** (3 days from now)
...
- [`2026-09-25.json`](2026-09-25.json) — today's raw output (if today's scan ran)
