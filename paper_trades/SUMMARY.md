...
- **3234** signals issued so far across **130** daily scans
- **711** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-06** (1 day from now)
...
- [`2026-09-05.json`](2026-09-05.json) — today's raw output (if today's scan ran)
