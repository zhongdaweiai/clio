...
- **635** signals issued so far across **27** daily scans
- **575** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-26** (2 days from now)
...
- [`2026-05-24.json`](2026-05-24.json) — today's raw output (if today's scan ran)
