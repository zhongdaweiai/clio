...
- **3433** signals issued so far across **136** daily scans
- **896** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-13** (2 days from now)
...
- [`2026-09-11.json`](2026-09-11.json) — today's raw output (if today's scan ran)
