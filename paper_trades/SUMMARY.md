...
- **3141** signals issued so far across **127** daily scans
- **640** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-03** (1 day from now)
...
- [`2026-09-02.json`](2026-09-02.json) — today's raw output (if today's scan ran)
