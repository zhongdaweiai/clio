...
- **3727** signals issued so far across **145** daily scans
- **1003** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-22** (2 days from now)
...
- [`2026-09-20.json`](2026-09-20.json) — today's raw output (if today's scan ran)
