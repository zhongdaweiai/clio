...
- **99** signals issued so far across **5** daily scans
- **95** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-15** (13 days from now)
...
- [`2026-05-02.json`](2026-05-02.json) — today's raw output (if today's scan ran)
