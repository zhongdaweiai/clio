...
- **936** signals issued so far across **43** daily scans
- **464** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-10** (1 day from now)
...
- [`2026-06-09.json`](2026-06-09.json) — today's raw output (if today's scan ran)
