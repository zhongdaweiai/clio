...
- **2947** signals issued so far across **120** daily scans
- **702** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-27** (1 day from now)
...
- [`2026-08-26.json`](2026-08-26.json) — today's raw output (if today's scan ran)
