...
- **2207** signals issued so far across **91** daily scans
- **786** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-28** (1 day from now)
...
- [`2026-07-27.json`](2026-07-27.json) — today's raw output (if today's scan ran)
