...
- **653** signals issued so far across **28** daily scans
- **593** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-26** (1 day from now)
...
- [`2026-05-25.json`](2026-05-25.json) — today's raw output (if today's scan ran)
