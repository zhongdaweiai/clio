...
- **53** signals issued so far across **3** daily scans
- **51** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-01** (1 day from now)
...
- [`2026-04-30.json`](2026-04-30.json) — today's raw output (if today's scan ran)
