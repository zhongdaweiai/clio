...
- **1153** signals issued so far across **55** daily scans
- **580** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-30** (9 days from now)
...
- [`2026-06-21.json`](2026-06-21.json) — today's raw output (if today's scan ran)
