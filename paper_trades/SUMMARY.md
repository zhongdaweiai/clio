...
- **1209** signals issued so far across **59** daily scans
- **634** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-26** (1 day from now)
...
- [`2026-06-25.json`](2026-06-25.json) — today's raw output (if today's scan ran)
