...
- **2485** signals issued so far across **102** daily scans
- **336** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-09** (1 day from now)
...
- [`2026-08-08.json`](2026-08-08.json) — today's raw output (if today's scan ran)
