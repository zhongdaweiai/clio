...
- **2349** signals issued so far across **97** daily scans
- **222** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-04** (2 days from now)
...
- [`2026-08-02.json`](2026-08-02.json) — today's raw output (if today's scan ran)
