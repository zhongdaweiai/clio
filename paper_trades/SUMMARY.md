...
- **1272** signals issued so far across **64** daily scans
- **345** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-01** (1 day from now)
...
- [`2026-06-30.json`](2026-06-30.json) — today's raw output (if today's scan ran)
