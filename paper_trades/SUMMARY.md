...
- **1070** signals issued so far across **50** daily scans
- **570** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-17** (1 day from now)
...
- [`2026-06-16.json`](2026-06-16.json) — today's raw output (if today's scan ran)
