...
- **2293** signals issued so far across **95** daily scans
- **286** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-01** (1 day from now)
...
- [`2026-07-31.json`](2026-07-31.json) — today's raw output (if today's scan ran)
