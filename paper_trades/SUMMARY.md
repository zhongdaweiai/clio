...
- **956** signals issued so far across **44** daily scans
- **479** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-11** (1 day from now)
...
- [`2026-06-10.json`](2026-06-10.json) — today's raw output (if today's scan ran)
