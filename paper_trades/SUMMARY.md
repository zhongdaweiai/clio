...
- **1636** signals issued so far across **74** daily scans
- **520** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-11** (1 day from now)
...
- [`2026-07-10.json`](2026-07-10.json) — today's raw output (if today's scan ran)
