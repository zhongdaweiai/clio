...
- **3501** signals issued so far across **138** daily scans
- **923** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-15** (2 days from now)
...
- [`2026-09-13.json`](2026-09-13.json) — today's raw output (if today's scan ran)
