...
- **2380** signals issued so far across **98** daily scans
- **253** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-04** (1 day from now)
...
- [`2026-08-03.json`](2026-08-03.json) — today's raw output (if today's scan ran)
