...
- **351** signals issued so far across **16** daily scans
- **347** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-15** (2 days from now)
...
- [`2026-05-13.json`](2026-05-13.json) — today's raw output (if today's scan ran)
