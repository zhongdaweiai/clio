...
- **917** signals issued so far across **42** daily scans
- **447** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-09** (1 day from now)
...
- [`2026-06-08.json`](2026-06-08.json) — today's raw output (if today's scan ran)
