...
- **427** signals issued so far across **19** daily scans
- **374** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-17** (1 day from now)
...
- [`2026-05-16.json`](2026-05-16.json) — today's raw output (if today's scan ran)
