...
- **2669** signals issued so far across **111** daily scans
- **470** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-18** (1 day from now)
...
- [`2026-08-17.json`](2026-08-17.json) — today's raw output (if today's scan ran)
