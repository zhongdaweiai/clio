...
- **3172** signals issued so far across **128** daily scans
- **669** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-05** (2 days from now)
...
- [`2026-09-03.json`](2026-09-03.json) — today's raw output (if today's scan ran)
