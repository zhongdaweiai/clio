...
- **2088** signals issued so far across **87** daily scans
- **672** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-24** (1 day from now)
...
- [`2026-07-23.json`](2026-07-23.json) — today's raw output (if today's scan ran)
