...
- **1592** signals issued so far across **73** daily scans
- **488** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-10** (1 day from now)
...
- [`2026-07-09.json`](2026-07-09.json) — today's raw output (if today's scan ran)
