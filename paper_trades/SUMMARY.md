...
- **331** signals issued so far across **15** daily scans
- **327** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-15** (3 days from now)
...
- [`2026-05-12.json`](2026-05-12.json) — today's raw output (if today's scan ran)
