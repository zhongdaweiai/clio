...
- **2275** signals issued so far across **94** daily scans
- **776** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-31** (1 day from now)
...
- [`2026-07-30.json`](2026-07-30.json) — today's raw output (if today's scan ran)
