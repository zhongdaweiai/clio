...
- **1240** signals issued so far across **62** daily scans
- **662** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-30** (2 days from now)
...
- [`2026-06-28.json`](2026-06-28.json) — today's raw output (if today's scan ran)
