...
- **1333** signals issued so far across **66** daily scans
- **270** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-03** (1 day from now)
...
- [`2026-07-02.json`](2026-07-02.json) — today's raw output (if today's scan ran)
