...
- **670** signals issued so far across **29** daily scans
- **557** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-27** (1 day from now)
...
- [`2026-05-26.json`](2026-05-26.json) — today's raw output (if today's scan ran)
