...
- **879** signals issued so far across **40** daily scans
- **494** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-07** (1 day from now)
...
- [`2026-06-06.json`](2026-06-06.json) — today's raw output (if today's scan ran)
