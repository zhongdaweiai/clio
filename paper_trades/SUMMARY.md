...
- **3072** signals issued so far across **125** daily scans
- **656** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-01** (1 day from now)
...
- [`2026-08-31.json`](2026-08-31.json) — today's raw output (if today's scan ran)
