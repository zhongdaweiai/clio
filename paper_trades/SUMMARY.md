...
- **457** signals issued so far across **20** daily scans
- **403** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-26** (9 days from now)
...
- [`2026-05-17.json`](2026-05-17.json) — today's raw output (if today's scan ran)
