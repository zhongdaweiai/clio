...
- **3795** signals issued so far across **147** daily scans
- **1070** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-28** (6 days from now)
...
- [`2026-09-22.json`](2026-09-22.json) — today's raw output (if today's scan ran)
