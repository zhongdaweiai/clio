...
- **16** signals issued so far across **1** daily scans
- **16** signals waiting for their markets to close
- Earliest pending resolution: **2026-04-30** (2 days from now)
...
- [`2026-04-28.json`](2026-04-28.json) — today's raw output (if today's scan ran)
