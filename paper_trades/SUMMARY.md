...
- **2117** signals issued so far across **88** daily scans
- **699** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-26** (2 days from now)
...
- [`2026-07-24.json`](2026-07-24.json) — today's raw output (if today's scan ran)
