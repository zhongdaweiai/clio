...
- **1895** signals issued so far across **81** daily scans
- **666** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-18** (1 day from now)
...
- [`2026-07-17.json`](2026-07-17.json) — today's raw output (if today's scan ran)
