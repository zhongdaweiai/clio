...
- **745** signals issued so far across **34** daily scans
- **409** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-01** (1 day from now)
...
- [`2026-05-31.json`](2026-05-31.json) — today's raw output (if today's scan ran)
