...
- **2653** signals issued so far across **110** daily scans
- **455** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-17** (1 day from now)
...
- [`2026-08-16.json`](2026-08-16.json) — today's raw output (if today's scan ran)
