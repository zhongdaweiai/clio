...
- **1958** signals issued so far across **83** daily scans
- **689** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-20** (1 day from now)
...
- [`2026-07-19.json`](2026-07-19.json) — today's raw output (if today's scan ran)
