...
- **1198** signals issued so far across **58** daily scans
- **624** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-25** (1 day from now)
...
- [`2026-06-24.json`](2026-06-24.json) — today's raw output (if today's scan ran)
