...
- **1055** signals issued so far across **49** daily scans
- **560** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-16** (1 day from now)
...
- [`2026-06-15.json`](2026-06-15.json) — today's raw output (if today's scan ran)
