...
- **1037** signals issued so far across **48** daily scans
- **555** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-15** (1 day from now)
...
- [`2026-06-14.json`](2026-06-14.json) — today's raw output (if today's scan ran)
