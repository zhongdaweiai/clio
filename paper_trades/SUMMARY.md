...
- **570** signals issued so far across **24** daily scans
- **512** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-24** (3 days from now)
...
- [`2026-05-21.json`](2026-05-21.json) — today's raw output (if today's scan ran)
