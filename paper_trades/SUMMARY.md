...
- **2615** signals issued so far across **108** daily scans
- **430** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-15** (1 day from now)
...
- [`2026-08-14.json`](2026-08-14.json) — today's raw output (if today's scan ran)
