...
- **1832** signals issued so far across **79** daily scans
- **616** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-16** (1 day from now)
...
- [`2026-07-15.json`](2026-07-15.json) — today's raw output (if today's scan ran)
