...
- **784** signals issued so far across **36** daily scans
- **409** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-03** (1 day from now)
...
- [`2026-06-02.json`](2026-06-02.json) — today's raw output (if today's scan ran)
