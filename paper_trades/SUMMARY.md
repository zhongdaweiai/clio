...
- **3858** signals issued so far across **149** daily scans
- **1133** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-28** (4 days from now)
...
- [`2026-09-24.json`](2026-09-24.json) — today's raw output (if today's scan ran)
