...
- **2438** signals issued so far across **100** daily scans
- **294** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-06** (1 day from now)
...
- [`2026-08-05.json`](2026-08-05.json) — today's raw output (if today's scan ran)
