...
- **3107** signals issued so far across **126** daily scans
- **607** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-02** (1 day from now)
...
- [`2026-09-01.json`](2026-09-01.json) — today's raw output (if today's scan ran)
