...
- **3694** signals issued so far across **144** daily scans
- **1004** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-20** (1 day from now)
...
- [`2026-09-19.json`](2026-09-19.json) — today's raw output (if today's scan ran)
