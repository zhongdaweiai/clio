...
- **2537** signals issued so far across **104** daily scans
- **384** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-11** (1 day from now)
...
- [`2026-08-10.json`](2026-08-10.json) — today's raw output (if today's scan ran)
