...
- **373** signals issued so far across **17** daily scans
- **369** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-15** (1 day from now)
...
- [`2026-05-14.json`](2026-05-14.json) — today's raw output (if today's scan ran)
