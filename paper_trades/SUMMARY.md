...
- **3331** signals issued so far across **133** daily scans
- **797** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-09** (1 day from now)
...
- [`2026-09-08.json`](2026-09-08.json) — today's raw output (if today's scan ran)
