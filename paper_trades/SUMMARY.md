...
- **1251** signals issued so far across **63** daily scans
- **673** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-30** (1 day from now)
...
- [`2026-06-29.json`](2026-06-29.json) — today's raw output (if today's scan ran)
