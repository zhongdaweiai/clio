...
- **488** signals issued so far across **21** daily scans
- **434** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-19** (1 day from now)
...
- [`2026-05-18.json`](2026-05-18.json) — today's raw output (if today's scan ran)
