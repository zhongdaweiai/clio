...
- **3364** signals issued so far across **134** daily scans
- **828** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-11** (2 days from now)
...
- [`2026-09-09.json`](2026-09-09.json) — today's raw output (if today's scan ran)
