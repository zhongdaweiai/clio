...
- **2689** signals issued so far across **112** daily scans
- **484** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-20** (2 days from now)
...
- [`2026-08-18.json`](2026-08-18.json) — today's raw output (if today's scan ran)
