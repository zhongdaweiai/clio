...
- **703** signals issued so far across **31** daily scans
- **555** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-31** (3 days from now)
...
- [`2026-05-28.json`](2026-05-28.json) — today's raw output (if today's scan ran)
