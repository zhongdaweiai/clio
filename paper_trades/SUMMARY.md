...
- **1124** signals issued so far across **53** daily scans
- **586** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-21** (2 days from now)
...
- [`2026-06-19.json`](2026-06-19.json) — today's raw output (if today's scan ran)
