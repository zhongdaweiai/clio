...
- **1219** signals issued so far across **60** daily scans
- **642** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-30** (4 days from now)
...
- [`2026-06-26.json`](2026-06-26.json) — today's raw output (if today's scan ran)
