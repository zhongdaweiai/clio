...
- **686** signals issued so far across **30** daily scans
- **538** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-31** (4 days from now)
...
- [`2026-05-27.json`](2026-05-27.json) — today's raw output (if today's scan ran)
