...
- **3569** signals issued so far across **140** daily scans
- **984** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-16** (1 day from now)
...
- [`2026-09-15.json`](2026-09-15.json) — today's raw output (if today's scan ran)
