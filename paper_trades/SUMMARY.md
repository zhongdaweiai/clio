...
- **1428** signals issued so far across **69** daily scans
- **347** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-06** (1 day from now)
...
- [`2026-07-05.json`](2026-07-05.json) — today's raw output (if today's scan ran)
