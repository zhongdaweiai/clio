...
- **1864** signals issued so far across **80** daily scans
- **646** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-17** (1 day from now)
...
- [`2026-07-16.json`](2026-07-16.json) — today's raw output (if today's scan ran)
