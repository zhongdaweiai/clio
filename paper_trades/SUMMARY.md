...
- **1183** signals issued so far across **57** daily scans
- **609** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-26** (3 days from now)
...
- [`2026-06-23.json`](2026-06-23.json) — today's raw output (if today's scan ran)
