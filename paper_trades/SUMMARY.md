...
- **3267** signals issued so far across **131** daily scans
- **737** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-07** (1 day from now)
...
- [`2026-09-06.json`](2026-09-06.json) — today's raw output (if today's scan ran)
