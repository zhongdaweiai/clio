...
- **1502** signals issued so far across **71** daily scans
- **405** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-08** (1 day from now)
...
- [`2026-07-07.json`](2026-07-07.json) — today's raw output (if today's scan ran)
