...
- **1087** signals issued so far across **51** daily scans
- **549** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-21** (4 days from now)
...
- [`2026-06-17.json`](2026-06-17.json) — today's raw output (if today's scan ran)
