...
- **2510** signals issued so far across **103** daily scans
- **358** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-10** (1 day from now)
...
- [`2026-08-09.json`](2026-08-09.json) — today's raw output (if today's scan ran)
