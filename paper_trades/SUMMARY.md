...
- **2978** signals issued so far across **121** daily scans
- **713** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-31** (3 days from now)
...
- [`2026-08-28.json`](2026-08-28.json) — today's raw output (if today's scan ran)
