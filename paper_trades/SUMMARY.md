...
- **807** signals issued so far across **37** daily scans
- **424** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-04** (1 day from now)
...
- [`2026-06-03.json`](2026-06-03.json) — today's raw output (if today's scan ran)
