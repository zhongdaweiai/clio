...
- **2798** signals issued so far across **116** daily scans
- **560** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-24** (2 days from now)
...
- [`2026-08-22.json`](2026-08-22.json) — today's raw output (if today's scan ran)
