...
- **2724** signals issued so far across **114** daily scans
- **486** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-24** (4 days from now)
...
- [`2026-08-20.json`](2026-08-20.json) — today's raw output (if today's scan ran)
