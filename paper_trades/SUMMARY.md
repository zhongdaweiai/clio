...
- **247** signals issued so far across **11** daily scans
- **243** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-15** (7 days from now)
...
- [`2026-05-08.json`](2026-05-08.json) — today's raw output (if today's scan ran)
