...
- **3663** signals issued so far across **143** daily scans
- **973** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-20** (2 days from now)
...
- [`2026-09-18.json`](2026-09-18.json) — today's raw output (if today's scan ran)
