...
- **1927** signals issued so far across **82** daily scans
- **693** signals waiting for their markets to close
- Earliest pending resolution: **2026-07-19** (1 day from now)
...
- [`2026-07-18.json`](2026-07-18.json) — today's raw output (if today's scan ran)
