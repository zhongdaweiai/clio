...
- **2410** signals issued so far across **99** daily scans
- **267** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-05** (1 day from now)
...
- [`2026-08-04.json`](2026-08-04.json) — today's raw output (if today's scan ran)
