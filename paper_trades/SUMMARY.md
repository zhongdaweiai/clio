...
- **2557** signals issued so far across **105** daily scans
- **394** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-13** (2 days from now)
...
- [`2026-08-11.json`](2026-08-11.json) — today's raw output (if today's scan ran)
