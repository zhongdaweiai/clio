...
- **2635** signals issued so far across **109** daily scans
- **439** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-16** (1 day from now)
...
- [`2026-08-15.json`](2026-08-15.json) — today's raw output (if today's scan ran)
