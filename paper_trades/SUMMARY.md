...
- **1017** signals issued so far across **47** daily scans
- **537** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-14** (1 day from now)
...
- [`2026-06-13.json`](2026-06-13.json) — today's raw output (if today's scan ran)
