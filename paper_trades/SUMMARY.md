...
- **3535** signals issued so far across **139** daily scans
- **957** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-15** (1 day from now)
...
- [`2026-09-14.json`](2026-09-14.json) — today's raw output (if today's scan ran)
