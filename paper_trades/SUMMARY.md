...
- **899** signals issued so far across **41** daily scans
- **430** signals waiting for their markets to close
- Earliest pending resolution: **2026-06-08** (1 day from now)
...
- [`2026-06-07.json`](2026-06-07.json) — today's raw output (if today's scan ran)
