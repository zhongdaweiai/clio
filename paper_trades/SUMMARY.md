...
- **3398** signals issued so far across **135** daily scans
- **862** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-11** (1 day from now)
...
- [`2026-09-10.json`](2026-09-10.json) — today's raw output (if today's scan ran)
