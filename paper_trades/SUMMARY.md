...
- **3047** signals issued so far across **124** daily scans
- **782** signals waiting for their markets to close
- Earliest pending resolution: **2026-08-31** (1 day from now)
...
- [`2026-08-30.json`](2026-08-30.json) — today's raw output (if today's scan ran)
