...
- **3634** signals issued so far across **142** daily scans
- **944** signals waiting for their markets to close
- Earliest pending resolution: **2026-09-20** (3 days from now)
...
- [`2026-09-17.json`](2026-09-17.json) — today's raw output (if today's scan ran)
