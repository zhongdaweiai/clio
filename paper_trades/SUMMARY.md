...
- **730** signals issued so far across **33** daily scans
- **582** signals waiting for their markets to close
- Earliest pending resolution: **2026-05-31** (1 day from now)
...
- [`2026-05-30.json`](2026-05-30.json) — today's raw output (if today's scan ran)
